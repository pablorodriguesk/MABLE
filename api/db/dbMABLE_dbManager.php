...
function getConnection() {
	...
	global $db_MABLE_db_Url, $db_MABLE_db_User, $db_MABLE_db_Pass, $db_MABLE_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_MABLE_db_Url.";dbname=".$db_MABLE_db_DbName, $db_MABLE_db_User, $db_MABLE_db_Pass);
